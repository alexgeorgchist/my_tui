...
## GET SCRIPT LIST
scriptlist=(6p.sh info.sh pogoda.sh pokoypsaltir.sh sysinfo.sh top_custom_info.sh topinfo.sh mm.sh mmload.sh scriptman.sh) # Massiv tem
about=(Шестопсалмие Инфопамять Казань О_упокоении О_системе ... ... Выбор_themes Загрузка_mm Загрузка_scripts)
